export default {
  encode: (domain: string = null, project: string = null, bundle: string = null, filepath: string = null, line: number = null, filter: string = null, sensitive: boolean = true, date_from: string = null, date_to: string = null) => {
